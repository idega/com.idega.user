...
public class UserApplicationMainAreaPS extends IWControlFramePresentationState implements IWActionListener {
	...
	private Collection<UserGroupPlugInBusiness> _plugins = null;
	...
	public Collection<UserGroupPlugInBusiness> getUserGroupPlugins() {
	...
	public void stateChanged(ChangeEvent e) {
		...
		if (object instanceof CreateGroupWindowPS) {
			...
			if (groupId != null) {
				...
				// group creation must have failed or the group type changed open the window again
				Link gotoLink = new Link();
