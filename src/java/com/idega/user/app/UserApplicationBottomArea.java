...
public class UserApplicationBottomArea extends Page implements IWBrowserView {
	...
	public void main(IWContext iwc) throws Exception {
		...
		Text text = new Text(iwrb.getLocalizedString("bottom_message", "© 2000-2007 | idega software | Engjavegi 6 | 104 Reykjavik | Iceland | Tel. +354 554 7557 | Fax +354 554 7749 | idega@idega.is"));
